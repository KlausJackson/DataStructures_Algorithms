...
My Python, C++ code and notes while learning about Data Structures and Algorithms.
...
A linear data structure where each node contains a data element and a reference (or pointer) to the next node in the list.
...
**Backtracking :** recursively exploring all possible solutions until a valid solution is found.

## Note

I added comments in the code, they're explainations based on my understanding.
